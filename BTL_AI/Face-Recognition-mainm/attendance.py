...
class FaceRecognition:
    def __init__(self, face_detect_path, excel_path):
        ...
        # Thông qua phương pháp create(), một đối tượng recognizer mới được tạo ra và sẵn sàng để huấn luyện 
        # và dự đoán khuôn mặt. Sau khi tạo đối tượng này, bạn có thể sử dụng nó để huấn luyện mô hình 
        # với dữ liệu ảnh, đồng thời cung cấp một số tham số có thể điều chỉnh để tối ưu hóa quá trình nhận dạng.
