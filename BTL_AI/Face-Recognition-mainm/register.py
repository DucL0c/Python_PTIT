...
class FaceRegister:
    ...
    def train_model(self):
        ...
        for imagePath in imagePaths:
            # Image.open và chuyển đổi sang chế độ ảnh xám bằng phương thức convert("L"). 
            # Sau đó, nó được chuyển đổi thành mảng numpy faceNp.
            faceImg = Image.open(imagePath).convert("L")
            # Ảnh xám sau đó được chuyển đổi thành mảng numpy với kiểu dữ liệu "uint8".
            # Mỗi mảng này đại diện cho một khuôn mặt trong tập dữ liệu huấn luyện.
            faceNp = np.array(faceImg, "uint8")
            #  Đoạn mã này trích xuất ID người dùng từ tên tệp ảnh. 
            # Đây giả định rằng tên tệp có định dạng "<tên>.<id>.jpg" hoặc tương tự.
